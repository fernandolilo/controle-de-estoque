...
namespace Paula {
    ...
    public partial class estoqueDataSet2 : global::System.Data.DataSet {
        ...
        public partial class estoqueDataTable : global::System.Data.TypedTableBase<estoqueRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public estoqueRow AddestoqueRow(string cod, string descricao, decimal preco, string marca, string fornecedor, string email_fornecedor, string nota, decimal valor_da_NF, string quantidade, double dia) {
...
namespace Paula.estoqueDataSet2TableAdapters {
    ...
    public partial class estoqueTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `estoque` WHERE ((`Id` = @p1) AND (`cod` = @p2) AND (`preco` = @p3) AND (`marca` = @p4) AND ((@p5 = 1 AND `fornecedor` IS NULL) OR (`fornecedor` = @p6)) AND ((@p7 = 1 AND `email_fornecedor` IS NULL) OR (`email_fornecedor` = @p8)) AND ((@p9 = 1 AND `nota` IS NULL) OR (`nota` = @p10)) AND ((@p11 = 1 AND `valor_da_NF` IS NULL) OR (`valor_da_NF` = @p12)) AND ((@p13 = 1 AND `quantidade` IS NULL) OR (`quantidade` = @p14)) AND ((@p15 = 1 AND `dia` IS NULL) OR (`dia` = @p16)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `estoque` (`cod`, `descricao`, `preco`, `marca`, `fornecedor`, `email" +
                "_fornecedor`, `nota`, `valor_da_NF`, `quantidade`, `dia`) VALUES (@p1, @p2, @p3," +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `estoque` SET `cod` = @p1, `descricao` = @p2, `preco` = @p3, `marca` = @p4, `fornecedor` = @p5, `email_fornecedor` = @p6, `nota` = @p7, `valor_da_NF` = @p8, `quantidade` = @p9, `dia` = @p10 WHERE ((`Id` = @p11) AND (`cod` = @p12) AND (`preco` = @p13) AND (`marca` = @p14) AND ((@p15 = 1 AND `fornecedor` IS NULL) OR (`fornecedor` = @p16)) AND ((@p17 = 1 AND `email_fornecedor` IS NULL) OR (`email_fornecedor` = @p18)) AND ((@p19 = 1 AND `nota` IS NULL) OR (`nota` = @p20)) AND ((@p21 = 1 AND `valor_da_NF` IS NULL) OR (`valor_da_NF` = @p22)) AND ((@p23 = 1 AND `quantidade` IS NULL) OR (`quantidade` = @p24)) AND ((@p25 = 1 AND `dia` IS NULL) OR (`dia` = @p26)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `Id`, `cod`, `descricao`, `preco`, `marca`, `fornecedor`, `email_fornecedo" +
                "r`, `nota`, `valor_da_NF`, `quantidade`, `dia` FROM `estoque`";
        ...
        public virtual int Fill(estoqueDataSet2.estoqueDataTable dataTable) {
        ...
        public virtual estoqueDataSet2.estoqueDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            estoqueDataSet2.estoqueDataTable dataTable = new estoqueDataSet2.estoqueDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(estoqueDataSet2.estoqueDataTable dataTable) {
        ...
        public virtual int Delete(int p1, string p2, decimal p3, string p4, string p6, string p8, string p10, global::System.Nullable<decimal> p12, string p14, global::System.Nullable<double> p16) {
        ...
        public virtual int Insert(string p1, string p2, decimal p3, string p4, string p5, string p6, string p7, global::System.Nullable<decimal> p8, string p9, global::System.Nullable<double> p10) {
            if ((p1 == null)) {
        ...
        public virtual int Update(
                    ...
                    string p24, 
                    global::System.Nullable<double> p26) {
            return this.Update(p12, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p16, p18, p20, p22, p24, p26);
        }
    }
